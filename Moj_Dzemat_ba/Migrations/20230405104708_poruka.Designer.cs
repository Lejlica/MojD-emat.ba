...
namespace MojDzematba.Migrations
{
    ...
    [Migration("20230405104708_poruka")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FIT_Api_Example.Modul1.Models.AktivacijaKviza", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AktivacijaKviza");
                });

            modelBuilder.Entity("FIT_Api_Example.Modul1.Models.KorisnikKvizPitanja", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("oznaceniOdgTekst")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("id");

                    b.HasIndex("KorisnikKvizId");

                    b.HasIndex("PitanjeId");

                    b.ToTable("KorisnikKvizPitanja");
                });
            ...
            modelBuilder.Entity("FIT_Api_Example.Modul2.Models.KorisnikKviz", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("AktivacijaKvizaId")
                        .HasColumnType("int");

                    b.Property<int>("korisnikPokrenuoId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AktivacijaKvizaId");

                    b.HasIndex("korisnikPokrenuoId");

                    b.ToTable("KorisnikKviz");
                });
            ...
            modelBuilder.Entity("FIT_Api_Example.Modul2.Models.Poruka", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FIT_Api_Example.Modul1.Models.KorisnikKvizPitanja", b =>
                {
                    b.HasOne("FIT_Api_Example.Modul2.Models.KorisnikKviz", "KorisnikKviz")
                        .WithMany()
                        .HasForeignKey("KorisnikKvizId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FIT_Api_Example.Modul2.Models.KorisnikKviz", b =>
                {
                    b.HasOne("FIT_Api_Example.Modul1.Models.AktivacijaKviza", "AktivacijaKviza")
                        .WithMany()
                        .HasForeignKey("AktivacijaKvizaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FIT_Api_Example.Modul0_Autentifikacija.Models.KorisnickiNalog", "korisnikPokrenuo")
                        .WithMany()
                        .HasForeignKey("korisnikPokrenuoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AktivacijaKviza");

                    b.Navigation("korisnikPokrenuo");
                });
            ...
            modelBuilder.Entity("FIT_Api_Example.Modul2.Models.Pitanje", b =>
                {
                    b.Navigation("ponudjeniOdgovori");
                });
